...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios.get("/api/posts/".concat(this.$route.params.slug)).then(function (api) {
      _this.posts = api.data;
...
var render = function () {
  ...
  return _c(
    "div",
    [_c("h1", [_vm._v("Home Pages")]), _vm._v(" "), _c("Posts")],
    1
  )
}
var staticRenderFns = []
...
var render = function () {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("h1", [_vm._v(_vm._s(_vm.posts.title))]),
    _vm._v(" "),
    _c("div", { domProps: { innerHTML: _vm._s(_vm.posts.content) } }),
    _vm._v(" "),
    _vm.posts.category
      ? _c("p", [_c("strong", [_vm._v("Categoria")])])
      : _vm._e(),
    _vm._v(" "),
    _vm.posts.tags.length > 0
      ? _c("div", [
    ...
    _vm._v(" "),
    _c("div", [
      _c("h4", [_vm._v("Lascia un Commmento")]),
      _vm._v(" "),
      _c(
        "form",
        {
        ...
        [
          _c("input", {
            ...
            attrs: { type: "text", id: "name", placeholder: "Nome Utente" },
...
module.exports = __webpack_require__(/*! /Users/lorenzobernardini/Documents/Boolean/LARA-DOC/laravel-boolpress/resources/js/front.js */"./resources/js/front.js");
